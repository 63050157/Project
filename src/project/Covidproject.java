...
public class Covidproject implements Serializable {
    ...
    public String toString() {
        return "project.Covidproject[ yearnum=" + yearnum + " ]";
    }
