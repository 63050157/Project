...
public class Project {
    ...
    public static void main(String[] args) throws JSONException, FileNotFoundException {
        ...
        JsonReader reader = Json.createReader(new FileReader("D:\\63050157\\componentProject.txt"));
        ...
        for(int i = 0; i < arr.length(); i++) {
            ...
            Covidproject cov = new Covidproject(yearnum, weeknum, new_case, total_case, new_case_excludeabroad, total_case_excludeabroad,
